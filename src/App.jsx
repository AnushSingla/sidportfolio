...
// Simple static text renderer
const T = ({ textKey, className, tag = "div", id }) => {
  const Tag = tag;
  return <Tag id={id} className={className}>{TEXTS[textKey]}</Tag>;
};
    ...
    <div className="min-h-screen bg-[#050505] text-gray-100 font-sans selection:bg-[#00C896] selection:text-black relative overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left z-10">
            ...
            <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight text-white leading-[1.08]">
              <T textKey="heroTitle1" tag="span" /> <br />
              <T textKey="heroTitle2" tag="span" className="text-[#00C896] font-serif italic normal-case font-normal" />
            </h1>

            <p className="text-gray-300 text-base sm:text-lg md:text-xl font-normal leading-relaxed max-w-2xl">
              <T textKey="heroBio" tag="span" /> <br className="hidden sm:inline" />
              <T textKey="heroBioBold" tag="strong" className="text-white font-bold" />
            </p>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-end mt-4 lg:mt-0">
            <div className="relative w-full max-w-md sm:max-w-lg flex flex-col items-center">
              ...
              <div className="relative z-20 -mt-4 px-5 py-2 rounded-full bg-[#0A0E0D]/95 backdrop-blur-md border border-[#00C896]/40 flex items-center gap-2.5 shadow-2xl">
                ...
                <T textKey="heroCredBadge" className="text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider" />
              </div>
            </div>
          </div>
      ...
      <section className="py-7 bg-[#080D0C] border-y-2 border-[#00C896]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          <T textKey="featuredTitle" className="font-display font-black text-sm sm:text-base md:text-lg text-[#00C896] uppercase tracking-widest whitespace-nowrap" />
          <div className="flex flex-wrap items-center justify-center md:justify-around gap-6 sm:gap-10 md:gap-14 text-white font-display font-black text-xs sm:text-base md:text-lg opacity-90">
            <T textKey="featured1" tag="span" />
            <T textKey="featured2" tag="span" />
            <T textKey="featured3" tag="span" />
            <T textKey="featured4" tag="span" />
          </div>
        </div>
      </section>

      {/* ==================== SECTION BANNER: WHAT I BELIEVE ? ==================== */}
      <T id="believe" textKey="believeBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
      ...
      <section className="py-16 sm:py-24 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <T textKey="believeTitle" tag="h2" className="text-2xl sm:text-4xl font-black text-white uppercase font-display tracking-tight" />
            <T textKey="believeP1" tag="p" className="text-gray-300 text-sm sm:text-lg leading-relaxed font-light" />
            ...
            <div className="p-5 sm:p-7 bg-[#080D0C] text-white rounded-2xl border-l-8 border-[#00C896] space-y-2 shadow-xl border border-gray-800">
              <T textKey="believeQuote" tag="p" className="text-base sm:text-lg font-serif italic text-[#00C896]" />
              <T textKey="believeQuoteSub" tag="p" className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-gray-400" />
            </div>

            <T textKey="believeP2" tag="p" className="text-gray-300 text-sm sm:text-base leading-relaxed font-light" />
            <T textKey="believeFooterQuote" tag="p" className="text-[#00C896] font-bold text-sm sm:text-base border-l-4 border-[#00C896] pl-4 italic" />
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full border-4 sm:border-8 border-[#00C896] bg-[#080D0C] shadow-2xl overflow-hidden flex items-center justify-center">
              ...
              <div className="absolute bottom-3 sm:bottom-4 bg-[#080D0C]/95 text-[#00C896] font-black text-[10px] sm:text-xs px-4 py-2 rounded-full border border-[#00C896] shadow-xl uppercase tracking-wider z-20">
                <T textKey="believeImgBadge" tag="span" />
              </div>
            </div>
          </div>
      ...
      <T id="built" textKey="builtBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
      ...
      <section className="py-16 sm:py-24 bg-[#080D0C]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-10 sm:space-y-14">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <T textKey="builtTitle" tag="h2" className="font-display font-black text-2xl sm:text-4xl text-white uppercase tracking-tight" />
            <T textKey="builtSub" tag="p" className="text-gray-300 text-sm sm:text-lg font-light" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-[#0A0E0D] border-t-4 border-[#00C896] border-x border-b border-gray-800 p-6 sm:p-8 rounded-2xl space-y-4 hover:-translate-y-1 transition-transform duration-300 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="builtPillar1Title" tag="h3" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-2" />
                <T textKey="builtPillar1Desc" tag="p" className="text-gray-300 text-xs sm:text-sm leading-relaxed font-light" />
              </div>
            </div>
            ...
            <div className="bg-[#0A0E0D] border-t-4 border-[#00C896] border-x border-b border-gray-800 p-6 sm:p-8 rounded-2xl space-y-4 hover:-translate-y-1 transition-transform duration-300 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="builtPillar2Title" tag="h3" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-2" />
                <T textKey="builtPillar2Desc" tag="p" className="text-gray-300 text-xs sm:text-sm leading-relaxed font-light" />
              </div>
            </div>
            ...
            <div className="bg-[#0A0E0D] border-t-4 border-[#00C896] border-x border-b border-gray-800 p-6 sm:p-8 rounded-2xl space-y-4 hover:-translate-y-1 transition-transform duration-300 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="builtPillar3Title" tag="h3" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-2" />
                <T textKey="builtPillar3Desc" tag="p" className="text-gray-300 text-xs sm:text-sm leading-relaxed font-light" />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-[#00C896]/40 bg-[#050505] shadow-2xl p-2.5 sm:p-3 relative">
            <div className="w-full h-64 sm:h-80 md:h-[460px] rounded-xl overflow-hidden relative">
              ...
              <div className="absolute bottom-4 left-6 right-6 flex flex-col md:flex-row justify-between items-start md:items-center text-white gap-3">
                <div>
                  <T textKey="teamTitle" tag="p" className="font-bold text-base sm:text-lg text-white" />
                  <T textKey="teamSub" tag="p" className="text-xs text-gray-300" />
                </div>
                <T textKey="teamBadge" tag="span" className="px-4 py-2 bg-[#00C896] text-black font-black text-xs uppercase tracking-wider rounded-lg shadow-lg flex-shrink-0" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0A0E0D] border-2 border-[#00C896] text-white rounded-3xl p-8 sm:p-14 shadow-2xl space-y-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-y lg:divide-y-0 lg:divide-x divide-gray-800">
              <div className="pt-3 lg:pt-0">
                <T textKey="stat1Num" className="font-display font-black text-3xl sm:text-5xl lg:text-6xl text-[#00C896]" />
                <T textKey="stat1Label" className="text-xs uppercase font-bold tracking-wider text-gray-300 mt-2" />
              </div>

              <div className="pt-3 lg:pt-0">
                <T textKey="stat2Num" className="font-display font-black text-3xl sm:text-5xl lg:text-6xl text-[#00C896]" />
                <T textKey="stat2Label" className="text-xs uppercase font-bold tracking-wider text-gray-300 mt-2" />
              </div>

              <div className="pt-3 lg:pt-0">
                <T textKey="stat3Num" className="font-display font-black text-3xl sm:text-5xl lg:text-6xl text-[#00C896]" />
                <T textKey="stat3Label" className="text-xs uppercase font-bold tracking-wider text-gray-300 mt-2" />
              </div>

              <div className="pt-3 lg:pt-0">
                <T textKey="stat4Num" className="font-display font-black text-3xl sm:text-5xl lg:text-6xl text-[#00C896]" />
                <T textKey="stat4Label" className="text-xs uppercase font-bold tracking-wider text-gray-300 mt-2" />
              </div>
            </div>

            <div className="text-center pt-6 border-t border-gray-800 space-y-2">
              <T textKey="statFooterSub" tag="p" className="text-xs sm:text-sm font-semibold text-gray-400" />
              <T textKey="statFooterQuote" tag="p" className="text-base sm:text-xl font-serif italic text-[#00C896]" />
            </div>
      ...
      <T id="majority" textKey="realityBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
      ...
      <section className="py-16 sm:py-24 bg-[#080D0C]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            <T textKey="realityTitle" tag="h2" className="font-display font-black text-2xl sm:text-4xl text-white uppercase leading-tight" />
            <T textKey="realitySub" tag="p" className="text-gray-300 text-sm sm:text-base font-light leading-relaxed" />
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-6 bg-[#0A0E0D] border border-gray-800 rounded-2xl space-y-2 shadow-lg hover:border-[#00C896] transition-colors">
              <T textKey="reality1Title" tag="h4" className="font-bold text-white text-base" />
              <T textKey="reality1Desc" tag="p" className="text-xs text-gray-400 leading-relaxed font-light" />
            </div>

            <div className="p-6 bg-[#0A0E0D] border border-gray-800 rounded-2xl space-y-2 shadow-lg hover:border-[#00C896] transition-colors">
              <T textKey="reality2Title" tag="h4" className="font-bold text-white text-base" />
              <T textKey="reality2Desc" tag="p" className="text-xs text-gray-400 leading-relaxed font-light" />
            </div>

            <div className="p-6 bg-[#0A0E0D] border border-gray-800 rounded-2xl space-y-2 shadow-lg hover:border-[#00C896] transition-colors">
              <T textKey="reality3Title" tag="h4" className="font-bold text-white text-base" />
              <T textKey="reality3Desc" tag="p" className="text-xs text-gray-400 leading-relaxed font-light" />
            </div>

            <div className="p-6 bg-[#0A0E0D] border border-gray-800 rounded-2xl space-y-2 shadow-lg hover:border-[#00C896] transition-colors">
              <T textKey="reality4Title" tag="h4" className="font-bold text-white text-base" />
              <T textKey="reality4Desc" tag="p" className="text-xs text-gray-400 leading-relaxed font-light" />
            </div>
          </div>
      ...
      <T id="speaking" textKey="speakingBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative">
              ...
              <T textKey="speakingBadge" tag="div" className="absolute -bottom-3 -right-3 bg-[#00C896] text-black font-black text-xs px-4 py-2 rounded-lg shadow-xl uppercase tracking-wider z-20" />
            </div>
          </div>

          {/* Right Text + Photo 4 Stage */}
          <div className="lg:col-span-7 space-y-6">
            <T textKey="speakingTitle" tag="h3" className="text-2xl sm:text-3xl font-black text-white uppercase font-display" />
            <T textKey="speakingDesc" tag="p" className="text-gray-300 text-sm sm:text-lg leading-relaxed font-light" />
      ...
      <T id="maps" textKey="mapsBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="rounded-2xl overflow-hidden border border-[#00C896]/40 bg-[#0A0E0D] p-2.5 shadow-2xl w-full relative">
                ...
                <div className="p-3 text-white text-center">
                  <T textKey="mapsQuote" tag="p" className="font-serif italic text-xs sm:text-sm text-[#00C896]" />
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-[#0A0E0D] text-white rounded-2xl border-t-4 border-[#00C896] border-x border-b border-gray-800 space-y-3 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <T textKey="mapsMTitle" tag="h4" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-1" />
                  <T textKey="mapsMSub" tag="p" className="text-xs uppercase font-bold tracking-wider text-gray-400 mb-2" />
                  <T textKey="mapsMDesc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
                </div>
              </div>
              ...
              <div className="p-6 bg-[#0A0E0D] text-white rounded-2xl border-t-4 border-[#00C896] border-x border-b border-gray-800 space-y-3 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <T textKey="mapsATitle" tag="h4" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-1" />
                  <T textKey="mapsASub" tag="p" className="text-xs uppercase font-bold tracking-wider text-gray-400 mb-2" />
                  <T textKey="mapsADesc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
                </div>
              </div>
              ...
              <div className="p-6 bg-[#0A0E0D] text-white rounded-2xl border-t-4 border-[#00C896] border-x border-b border-gray-800 space-y-3 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <T textKey="mapsPTitle" tag="h4" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-1" />
                  <T textKey="mapsPSub" tag="p" className="text-xs uppercase font-bold tracking-wider text-gray-400 mb-2" />
                  <T textKey="mapsPDesc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
                </div>
              </div>
              ...
              <div className="p-6 bg-[#0A0E0D] text-white rounded-2xl border-t-4 border-[#00C896] border-x border-b border-gray-800 space-y-3 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <T textKey="mapsSTitle" tag="h4" className="font-display font-extrabold text-lg sm:text-xl text-[#00C896] mb-1" />
                  <T textKey="mapsSSub" tag="p" className="text-xs uppercase font-bold tracking-wider text-gray-400 mb-2" />
                  <T textKey="mapsSDesc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
                </div>
              </div>
            </div>
      ...
      <T id="lessons" textKey="lessonsBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
      ...
      <section className="py-16 sm:py-24 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-10 sm:space-y-14">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <T textKey="lessonsTitle" tag="h2" className="font-display font-black text-2xl sm:text-4xl text-white uppercase tracking-tight" />
            <T textKey="lessonsSub" tag="p" className="text-gray-300 text-sm sm:text-lg font-light" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#0A0E0D] text-white p-6 rounded-2xl border-2 border-[#00C896] space-y-3 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="lesson1Title" tag="h3" className="font-display font-bold text-lg sm:text-xl text-[#00C896] mb-1" />
                <T textKey="lesson1Desc" tag="p" className="text-gray-300 text-xs sm:text-sm leading-relaxed font-light" />
              </div>
            </div>
            ...
            <div className="bg-[#0A0E0D] text-white p-6 rounded-2xl border-2 border-[#00C896] space-y-3 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="lesson2Title" tag="h3" className="font-display font-bold text-lg sm:text-xl text-[#00C896] mb-1" />
                <T textKey="lesson2Desc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
              </div>
            </div>
            ...
            <div className="bg-[#0A0E0D] text-white p-6 rounded-2xl border-2 border-[#00C896] space-y-3 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="lesson3Title" tag="h3" className="font-display font-bold text-lg sm:text-xl text-[#00C896] mb-1" />
                <T textKey="lesson3Desc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
              </div>
            </div>
            ...
            <div className="bg-[#0A0E0D] text-white p-6 rounded-2xl border-2 border-[#00C896] space-y-3 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <T textKey="lesson4Title" tag="h3" className="font-display font-bold text-lg sm:text-xl text-[#00C896] mb-1" />
                <T textKey="lesson4Desc" tag="p" className="text-xs sm:text-sm text-gray-300 leading-relaxed font-light" />
              </div>
            </div>
          </div>
      ...
      <T textKey="beyondBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
      ...
      <section className="py-16 sm:py-24 bg-[#080D0C]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <T textKey="beyondTitle" tag="h3" className="text-2xl sm:text-3xl font-black text-white uppercase font-display" />
            <T textKey="beyondDesc" tag="p" className="text-gray-300 text-sm sm:text-lg leading-relaxed font-light" />

            <div className="p-6 bg-[#050505] text-white rounded-2xl border-l-8 border-[#00C896] border border-gray-800">
              <T textKey="beyondQuote" tag="p" className="text-base sm:text-xl font-serif italic text-[#00C896]" />
            </div>
          </div>
      ...
      <T textKey="riseBanner" className="section-banner-dark py-5 px-6 text-center text-lg sm:text-2xl md:text-3xl" />
      ...
      <section className="py-16 sm:py-24 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <T textKey="riseTitle" tag="h3" className="text-2xl sm:text-4xl font-black text-[#00C896] uppercase font-display" />
            <T textKey="riseP1" tag="p" className="text-gray-300 text-sm sm:text-lg leading-relaxed font-light" />
            <T textKey="riseP2" tag="p" className="text-gray-300 text-xs sm:text-base leading-relaxed font-light" />
      ...
      <footer className="py-10 sm:py-12 bg-[#080D0C] text-gray-400 text-xs sm:text-sm border-t-2 border-[#00C896]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 text-center md:text-left">
          <div>
            <T textKey="footerName" tag="p" className="font-display font-black text-white text-base" />
            <T textKey="footerSub" tag="p" className="text-[11px] sm:text-xs text-gray-400 mt-1" />
          </div>
